...
static std::unordered_map<void*, TextureInfo> s_TextureCache;
...
VkDescriptorSet ImGui_ImplVulkan_AddTexture(VkSampler sampler, VkImageView image_view, VkImageLayout image_layout)
{
    ...
    if (s_TextureCache.find((void*)image_view) == s_TextureCache.end())
    {
        TextureInfo& info = s_TextureCache[(void*)image_view];
        ...
        info.DescriptorSet = descriptor_set;
    }

    TextureInfo& info = s_TextureCache.at((void*)image_view);

    // Update the Descriptor Set:
    {
        VkDescriptorImageInfo desc_image[1] = {};
        desc_image[0].sampler = info.Sampler;
        desc_image[0].imageView = info.ImageView;
        desc_image[0].imageLayout = info.ImageLayout;

        VkWriteDescriptorSet write_desc[1] = {};
        write_desc[0].sType = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
        write_desc[0].dstSet = info.DescriptorSet;
